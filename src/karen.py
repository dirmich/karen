...
if __name__ == "__main__":
    ...
    listener_group.add_argument('--speaker-model', default="../models/speech/deepspeech-0.7.4-models.pbmm", help="DeepSpeech model file")
    ...
    watcher_group.add_argument('--watcher-model', default="../models/watcher/haarcascade_frontalface_default.xml", help="OpenCV2 Model for Face Recognition")
    watcher_group.add_argument('--watcher-trained', default="/tmp/faces.yml", help="Trained faces file")
    ...
    watcher_group.add_argument('--watcher-input-folder', default=None, help="Folder containing face images for training.")
